  ...
  return (
      <Container>
        <div className="body">
          ...
          <div className="title">Don Quijote de la Mancha</div>
          <div className="author">Miguel de Cervantes</div>
          <img
            className="image"
          ...
          {/* <div className="pageNumber" render={({ pageNumber, totalPages }) => (
